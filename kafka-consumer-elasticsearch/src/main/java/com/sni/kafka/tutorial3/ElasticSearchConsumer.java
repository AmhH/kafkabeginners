package com.sni.kafka.tutorial3;
...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        //https://v7ml5lwju4:ml3yqh60m2@kafka-course-2025591721.us-east-1.bonsaisearch.net:443
        // replace with your own credentials
        String hostname = "kafka-course-2025591721.us-east-1.bonsaisearch.net"; // localhost or bonsai url
        String username = "v7ml5lwju4"; // needed only for bonsai
        String password = "ml3yqh60m2"; // needed only for bonsai
